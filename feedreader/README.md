...
Download the code in the zip folder and open the application by double clicking on the index.html file. Once the project is open and running, when you scroll to the bottom you will see the jasmine test results.
